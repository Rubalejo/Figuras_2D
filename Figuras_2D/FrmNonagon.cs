...
namespace Figuras_2D
{
    public partial class FrmNonagon : Form
    {
        ...
        //  Clase con nombre único
        NonagonHelper op = new NonagonHelper();
        ...
        private void panel1_Paint(object sender, PaintEventArgs e)
        {
            ...
            using (SolidBrush relleno = new SolidBrush(Color.Coral))
            {
    ...
    // CLASE AUXILIAR ÚNICA 
    public class NonagonHelper
    {
        public PointF[] CalcularPuntos(int lados, float radio, int ancho, int alto)
        {
            ...
            {
                // 👇 Ajuste leve para mejor orientación visual
